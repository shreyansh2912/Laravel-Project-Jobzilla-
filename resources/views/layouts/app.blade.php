...
<!-- Mirrored from thewebmax.org/jobzilla/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Sep 2023 07:22:37 GMT -->
<head>
                            ...
                            <div class="extra-cell">
                                <div class="header-nav-btn-section">
                                    ...
                                    <div class="twm-nav-btn-left">
                                        <a href="register" class="twm-nav-sign-up"  href="register" role="button">
                                            <i class="feather-log-in">REGISTER</i> 
                                        </a>
                                    </div>
                                    <div class="twm-nav-btn-left">    
                                        <a href="login" class="twm-nav-sign-up"  href="login" role="button">
                                            <i class="feather-log-in">LOGIN</i> {{-- Sign Up --}}
                                        </a>
                                    </div>
                                    @else
                                    <div class="twm-nav-btn-left">
                                        <a  class="twm-nav-sign-up" href="/logout" role="button"> 
                    ...
                    <div class="modal-content">
                        ...
                        <form action="" method="POST" >
                            ...
                            <div class="modal-footer">
                                <span class="modal-f-title">Login or Sign up with</span>
                                <ul class="twm-modal-social">
                                    <li><a href="assets/javascript.html" class="facebook-clr"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="assets/javascript.html" class="twitter-clr"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="assets/javascript.html" class="linkedin-clr"><i class="fab fa-linkedin-in"></i></a></li>
                                    <li><a href="assets/javascript.html" class="google-clr"><i class="fab fa-google"></i></a></li>
                                </ul>
                            </div>
                        </form>
                    </div>
...
<!-- Mirrored from thewebmax.org/jobzilla/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Sep 2023 07:26:37 GMT -->
</html>

...
<div class="alert alert-success" role="alert">
 ...
 <!-- CONTENT START -->
  <div class="page-content">
    ...
    <!--Banner Start-->
    <div class="twm-home1-banner-section site-bg-gray bg-cover" style="background-image:url(assets/images/main-slider/slider1/bg1.jpg)">
        <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="twm-w-process-steps">
                            ...
                            <div class="twm-w-pro-top bg-clr-sky">
                                <div class="twm-media">
                                    <span><img src="{{asset('assets/images/work-process/icon1.png')}}" alt="icon1"></span>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="twm-w-process-steps">
                            ...
                            <div class="twm-w-pro-top bg-clr-pink">
                                <div class="twm-media">
                                    <span><img src="{{asset('assets/images/work-process/icon2.png')}}" alt="icon1"></span>
                                </div>
    ...
    <div class="section-full p-t120 p-b120 twm-explore-area bg-cover " style="background-image: url(assets/images/background/bg-1.jpg);">
        <div class="container">
                    ...
                    <div class="owl-carousel home-client-carousel2 owl-btn-vertical-center">
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                ...
                                <a href="employer-list.html"><img src="{{asset('assets/images/client-logo/w1.png')}}" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="{{asset('assets/images/client-logo/w2.png')}}" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="{{asset('assets/images/client-logo/w3.png')}}" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="assets/images/client-logo/w4.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="assets/images/client-logo/w5.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="assets/images/client-logo/w6.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="assets/images/client-logo/w1.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="assets/images/client-logo/w2.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="employer-list.html"><img src="assets/images/client-logo/w3.png" alt=""></a></div>
                            </div>
                        </div>

                                                ...
                                                <div class="row">
                                                        <div class="col-xl-6 col-lg-6 col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="ls-inputicon-box"> 
                                                                    <input class="form-control" name="highest_qualification" type="text" placeholder="Your Highest Qualification" value="{{old('highest_qualification')}}">
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-12">
                                                            <div class="form-group">
                                                                <label>Course</label>
                                                                <div class="ls-inputicon-box"> 
                                                                    <input class="form-control" name="course" type="text" placeholder="Your Course" value="{{old('course')}}">
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="ls-inputicon-box"> 
                                                                    <input class="form-control" name="specialization" type="text" placeholder="Your Specialization" value="{{old('specialization')}}">
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="ls-inputicon-box"> 
                                                                    <input class="form-control" name="university" type="text" placeholder="University/College" value="{{old('university')}}">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="ls-inputicon-box"> 
                                                                    <input class="form-control" name="education" type="text" placeholder="Tell us about your current city" value="{{old('education')}}">
